...
class ExportService {
	...
	def private createExportDataJob(userName, params, statusList) {
        ...
        jdm.filters = params.filters // pass export filters. See {@link HighDimExportService#createDataConstraints(HighDimensionDataTypeResource, List<Map>)} for a description.
