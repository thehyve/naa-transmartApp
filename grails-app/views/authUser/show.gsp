			...
			<div class="dialog">
				...
				<tbody>
					...
					<tr class="prop">
						...
						<td valign="top" class="value">
							<ul>
							<g:each in="${search.SecureObjectAccess.findAllByPrincipal(person,[sort:accessLevel])}" var='soa'>
						...
						<td valign="top" class="value">
							<ul>
							<g:each in="${search.AuthUserSecureAccess.findAllByAuthUser(person,[sort:accessLevel])}" var='soa'>
