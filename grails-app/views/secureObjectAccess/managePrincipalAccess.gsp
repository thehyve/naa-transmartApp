                          ...
                          <tr class="prop">
                                <td valign="top" class="name" >
                                    <label for="secureObject">Secure Object:</label>
                                     <g:select optionKey="id" optionValue="displayName" from="${search.SecureObject.listOrderByDisplayName()}" name="secureobjectid" value="${secureObjectInstance?.id}" onchange="document.secobjaccessform.submit();"></g:select>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name" >
                                    ...
                                    <g:select optionKey="id" optionValue="accessLevelName" from="${search.SecureAccessLevel.list()}" name="accesslevelid" value="${accesslevelid}" onchange="document.secobjaccessform.submit();"></g:select>
                                </td>
                            </tr>
				</tbody>
				</table>
